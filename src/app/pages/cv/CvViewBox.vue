...
import CvBody from './components/body/CvBody.vue';
...
#cv {
  ...
  /* print styling */
  @apply [color-adjust:exact] print:flex print:m-0 print:p-0 print:break-after-page print:w-[21cm] print:h-[29.7cm] print:border-0 print:rounded-none;
  /* color-adjust: exact; */
  /* zoom: 100%; */
}
/* @page {
